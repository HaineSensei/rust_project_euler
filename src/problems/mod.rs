...
pub static PROBLEMS: LazyLock<HashMap<usize, ProblemInfo>> = LazyLock::new(|| {
    ...
    problems.insert(27, ProblemInfo { solver: p027::main, status: ProblemStatus::Complete });
    ...
    problems.insert(32, ProblemInfo { solver: p032::main, status: ProblemStatus::Complete });
    problems.insert(33, ProblemInfo { solver: p033::main, status: ProblemStatus::Complete });
    problems.insert(34, ProblemInfo { solver: p034::main, status: ProblemStatus::Complete });
    problems.insert(35, ProblemInfo { solver: p035::main, status: ProblemStatus::Complete });
